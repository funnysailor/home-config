...
beautiful.init("/home/sm/.config/awesome/themes/dust/theme.lua")
...
function run_once(nm,prg, times)
   if not prg then
   do return nil end
   end
   times = times or 1
   count_prog = tonumber(awful.util.pread('ps aux | grep "' .. nm .. '" | grep -v grep | wc -l'))
...
function getBatteryStatus()
  local fd= io.popen("/home/sm/.config/awesome/battery.sh")
...
run_once("kbdd","kbdd")
run_once("wicd-client","wicd-gtk -t")
run_once("xscreensaver","xscreensaver &")
run_once("volumeicon","volumeicon &")
run_once("xrandr","xrandr --auto --output HDMI2 --mode 1920x1080 --right-of LVDS1 --output HDMI3 --mode 1920x1080 --right-of HDMI2")

--awful.util.spawn_with_shell("kbdd")
--awful.util.spawn_with_shell("xset b 0 0 0")
--awful.util.spawn_with_shell("xscreensaver &")
--awful.util.spawn_with_shell("volumeicon &")
--awful.util.spawn_with_shell("wicd-gtk -t")
--awful.util.spawn_with_shell("xrandr --output HDMI3 --mode 1920x1080 --rate 75 --left-of LVDS1 --mode 1600x900 --rate 75")
